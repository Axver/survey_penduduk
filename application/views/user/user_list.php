...
<div id="wrapper">
	...
	<div id="content-wrapper" class="d-flex flex-column" style="background-color: #0b2e13">
		...
		<div id="content">
			...
			<!-- Topbar -->
			<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow"  style="background-color: #D0DBC2">
				...
				<div class="row">
					...
					<div class="col-xl-8 col-lg-7">
						<div class="card shadow mb-4">
							...
							<!-- Card Body -->
							<div class="card-body">
								<h2 style="margin-top:0px">Daftar Users</h2>
									...
									foreach ($user_data as $user)
									{
										...
										<tr>
											...
											<td style="text-align:center" width="200px">
												<?php
												echo anchor(site_url('user/read/'.$user->username),'Read');
												echo ' | ';
												echo anchor(site_url('user/update/'.$user->username),'Update');
												echo ' | ';
												echo anchor(site_url('user/delete/'.$user->username),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
												?>
											</td>
										</tr>
										<?php
