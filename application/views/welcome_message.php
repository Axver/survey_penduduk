...
<head>
	...
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= base_url('login_assets/fonts/iconic/css/material-design-iconic-font.min.css') ?>">
	<!--===============================================================================================-->
...
<div class="limiter">
	<div class="container-login100" style="background-image: url('<?= base_url("login_assets/images/bg-01.jpg") ?>');">
		<div class="wrap-login100">
			<form class="login100-form validate-form" action="<?= base_url('/welcome/login') ?>" method="POST">
				...
				<h6 style="color:red"><?php echo $this->session->flashdata('login'); ?></h6>
				<br/>
